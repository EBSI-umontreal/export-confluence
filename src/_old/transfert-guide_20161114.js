...
var wikiURL = 'https://wiki.umontreal.ca';
var pageIndex = '/pages/viewpage.action?pageId=124093923';

casper.start(wikiURL + pageIndex, function() {
...
grabContent = function() {
	...
	casper.thenOpen(links[currentLink], function() {
